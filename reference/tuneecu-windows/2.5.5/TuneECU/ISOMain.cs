...
public class ISOMain : Form
{
				...
				else
				{
					if (array[0] == 100)
					{
						...
						else
						{
							...
							if (text == "0")
							{
								text = string.Format("{0:x}",(array[19] << 16) | (array[20] << 8) | array[21]);
							}
						}
					}
					else
	...
	private byte[] ReadFile(string filePath, bool first)
	{
		...
		try
		{
			...
			else if (array[0] == 100)
			{
				...
				if ((num7 >= 8) & (num7 <= 12))
				{
					text2 = string.Format("{0:x6}",(array[11] << 16) | (array[12] << 8) | array[13]);
				}
				else
				{
					text2 = string.Format("{0:x}",ISORead.IDSagem((array[11] << 16) | (array[12] << 8) | array[13]));
					if (text2 == "0")
					{
						text2 = string.Format("{0:x}",(array[19] << 16) | (array[20] << 8) | array[21]);
					}
				}
			}
			else
			{
				text2 = string.Format("{0:x}",(array[19] << 16) | (array[12] << 8) | array[13]);
			}
	...
	public void QueryConnect()
	{
		...
		else if (serialMode & !comFailed)
		{
			...
			{
				DisplayBox("", LangUI[mLang, 340] + ((Control)cmbPortName).Text + LangUI[mLang, 358], 2);
				comFailed = true;
			}
		}
		else if (selectedIndex2 != -1)
		{
			...
			{
				DisplayBox("", LangUI[mLang, 340] + ((Control)lbDevList).Text + LangUI[mLang, 358], 2);
			}
		}
	...
	public static void UploadDone()
	{
		...
		for (num5 = 0; num5 < 128; num5++)
		{
			...
			if (num6 != -1)
			{
				...
				string text2 = ((num9 <= 0) ? "????  " : string.Format("{0:x}",num9));
				string text3 = string.Format("{0:x}",num8);
	...
	private void tvTests_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
	{
		...
		if (((int)e.Node.Tag == 4) & (btnTest == -1))
		{
			if (_Walbro)
			{
				byte b = (byte)ISORead.dataNum[16];
				if (b > 60)
				{
					DisplayBox("", LangUI[mLang, 302], 4);
					return;
				}
				...
				int value = ISORead.byte2String(b);
				rstTrim = true;
				btnTest = e.Node.Index;
				rTrim = btnTest;
				ISORead.mTrim = 0;
				ISORead.walbroSetTPS(0, value);
				ISORead.setWBTrim = 1;
	...
	public static string getVersion()
	{
		...
		string text = (executingAssembly.GetName().Version.Build).ToString();
		text = ((text != "0") ? ("." + text) : "");
		return "v " + executingAssembly.GetName().Version.Major.ToString() + "." + (executingAssembly.GetName().Version.Minor + text);
	}
	...
	private void InitializeComponent()
	{
		...
		//IL_325e: Unknown result type (might be due to invalid IL or missing references)
		//IL_3268: Expected O, but got Unknown
		//IL_32b7: Unknown result type (might be due to invalid IL or missing references)
		...
		//IL_3395: Expected O, but got Unknown
		...
		//IL_35a1: Expected O, but got Unknown
		...
		//IL_39f1: Expected O, but got Unknown
		...
		//IL_3ab0: Expected O, but got Unknown
		...
		//IL_3fbb: Expected O, but got Unknown
		...
		//IL_43ef: Expected O, but got Unknown
		...
		//IL_451f: Expected O, but got Unknown
		...
		//IL_4643: Expected O, but got Unknown
		//IL_46da: Unknown result type (might be due to invalid IL or missing references)
		//IL_46e4: Expected O, but got Unknown
		//IL_47a2: Unknown result type (might be due to invalid IL or missing references)
		//IL_47ac: Expected O, but got Unknown
		//IL_4ec7: Unknown result type (might be due to invalid IL or missing references)
		//IL_4ed1: Expected O, but got Unknown
		...
		//IL_54f4: Expected O, but got Unknown
		...
		//IL_5539: Expected O, but got Unknown
		//IL_5546: Unknown result type (might be due to invalid IL or missing references)
		//IL_5550: Expected O, but got Unknown
		...
		((Control)cModifMenu).Size = new Size(107, 26);
		...
		((ToolStripItem)modifSubMenu).Size = new Size(106, 22);
		((ToolStripItem)modifSubMenu).Tag = -1;
		...
		((Control)menuStrip).Size = new Size(199, 24);
		...
		((ToolStripDropDownItem)fileMenuItem).DropDownItems.AddRange((ToolStripItem[])(object)new ToolStripItem[8]
		{
		...
		((ToolStripItem)fileMenuItem).Size = new Size(23, 20);
		...
		((ToolStripItem)openMenuItem).Size = new Size(147, 22);
		...
		((ToolStripItem)compareMenuItem).Size = new Size(147, 22);
		...
		((ToolStripItem)saveMenuItem).Size = new Size(147, 22);
		...
		((ToolStripItem)sepPMenuItem).Size = new Size(144, 6);
		((ToolStripItem)PCIIIMenuItem).Enabled = false;
		((ToolStripItem)PCIIIMenuItem).Name = "PCIIIMenuItem";
		((ToolStripItem)PCIIIMenuItem).Size = new Size(147, 22);
		...
		((ToolStripItem)quitMenuItem).Size = new Size(147, 22);
		...
		((ToolStripItem)editMenuItem).Size = new Size(33, 20);
		...
		((ToolStripItem)copyMenuItem).Size = new Size(181, 22);
		...
		((ToolStripItem)pasteMenuItem).Size = new Size(181, 22);
		...
		((ToolStripItem)sepTMenuItem).Size = new Size(178, 6);
		((ToolStripItem)exportMenuItem).Enabled = false;
		((ToolStripItem)exportMenuItem).Name = "exportMenuItem";
		((ToolStripItem)exportMenuItem).Size = new Size(181, 22);
		...
		((ToolStripItem)sepEMenuItem).Size = new Size(178, 6);
		((ToolStripItem)useTrimMenuItem).Name = "useTrimMenuItem";
		((ToolStripItem)useTrimMenuItem).Size = new Size(181, 22);
		...
		((ToolStripItem)TrimToLMenuItem).Size = new Size(181, 22);
		...
		((ToolStripItem)fusionMenuItem).Size = new Size(181, 22);
		...
		((ToolStripItem)displayMenuItem).Size = new Size(48, 20);
		...
		((ToolStripItem)graphMenuItem).Size = new Size(137, 22);
		...
		((ToolStripItem)infosMapMenuItem).Size = new Size(137, 22);
		...
		((ToolStripItem)logMenuItem).Size = new Size(137, 22);
		...
		((ToolStripItem)sepSMenuItem).Size = new Size(134, 6);
		((ToolStripItem)fullScreenMenuItem).Name = "fullScreenMenuItem";
		fullScreenMenuItem.ShortcutKeys = (Keys)121;
		((ToolStripItem)fullScreenMenuItem).Size = new Size(137, 22);
		...
		((ToolStripItem)ECUMenuItem).Size = new Size(35, 20);
		...
		((ToolStripItem)connectMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)sepLMenuItem).Size = new Size(142, 6);
		((ToolStripItem)historyMenuItem).Enabled = false;
		((ToolStripItem)historyMenuItem).Name = "historyMenuItem";
		((ToolStripItem)historyMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)readMapMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)sepRMenuItem).Size = new Size(142, 6);
		...
		((ToolStripItem)flashMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)safeMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)toolStripSepR).Size = new Size(142, 6);
		((ToolStripItem)razTPSMenuItem).Enabled = false;
		((ToolStripItem)razTPSMenuItem).Name = "razTPSMenuItem";
		((ToolStripItem)razTPSMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)eraseCodesMenuItem).Size = new Size(145, 22);
		...
		((ToolStripItem)optionsMenuItem).Size = new Size(52, 20);
		((ToolStripItem)optionsMenuItem).Text = "&Options";
		((ToolStripItem)autoMenuItem).Name = "autoMenuItem";
		((ToolStripItem)autoMenuItem).Size = new Size(131, 22);
		...
		((ToolStripItem)DevMenuItem).Size = new Size(131, 22);
		...
		((ToolStripItem)serialMenuItem).Size = new Size(92, 22);
		...
		((ToolStripItem)uSBMenuItem).Size = new Size(92, 22);
		...
		((ToolStripItem)languageMenuItem).Size = new Size(131, 22);
		((ToolStripItem)languageMenuItem).Text = "&Language";
		((ToolStripItem)englishMenuItem).Name = "englishMenuItem";
		((ToolStripItem)englishMenuItem).Size = new Size(120, 22);
		...
		((ToolStripItem)frenchMenuItem).Size = new Size(120, 22);
		...
		((ToolStripItem)germanMenuItem).Size = new Size(120, 22);
		...
		((ToolStripItem)italianMenuItem).Size = new Size(120, 22);
		...
		((ToolStripItem)spanishMenuItem).Size = new Size(120, 22);
		...
		((ToolStripItem)portugueseMenuItem).Size = new Size(120, 22);
		...
		((Control)cActiveMenu).Size = new Size(100, 26);
		...
		((ToolStripItem)activeSubMenu).Size = new Size(99, 22);
		...
		((ToolStripItem)pasteSubMenu).Size = new Size(93, 22);
		...
		((Control)cTrimMenu).Size = new Size(90, 26);
		((Control)cTrimMenu).Click += cTrimMenu_Click;
		((ToolStripItem)trimSubMenu).Name = "trimSubMenu";
		((ToolStripItem)trimSubMenu).Size = new Size(89, 22);
		...
		{
			{
				...
				"Checksum : ", "Vehicule", "Parameters", "Throttle Table", "&Cancel", "&Ok", "Cl&ear", "&Close", "Interface", "Download",
				...
				"Switch ignition off and adjust throttle cable...", "Disable only if the 2nd Throttle valves\ror 2nd Throttle device (stepping motor & 2nd TPS) are removed", "TPS voltage too high", "Reset &Adaption", "Reset Adaption ?", "Reset Adaption done.\r", "Please wait... positioning the butterfly valve", "The exhaust butterfly cables can now be adjust, double-click on \"Adjust EXBV\" when done", "Adjust EXBV...\r", "Adjust EXBV done",
				...
				"Turn ignition off\rUnplug the programming connector\rTurn ignition on", "", "Download done... ", "", "ECU recovery done... ", "", "Unable to communicate with Port ", "", "", "",
				""
			},
			{
				...
				"Couper le contact et régler le cable d'accélérateur...", "Ne désactiver les papillons secondaires que si les papillons\rou le système secondaire (moteur PAP et 2e TPS) sont enlevés", "Tension TPS trop forte", "Réinitialiser &adaptation", "Réinitialiser adaptation ?", "Réinitialisation adaptation terminé.\r", "Veuillez patienter... positionnement de la valve d'échappement", "Régler les cables de la valve d'échappement, et ensuite double-cliquer sur \"Réglage valve échap.\"", "Réglage valve échappement...\r", "Réglage valve échappement terminé",
				...
				"Couper le contact\rDébrancher le connecteur de programmation\rRemettre le contact", "", "Téléchargement terminé... ", "", "Récupération de l'ECU terminé... ", "", "Impossible de communiquer avec le Port ", "", "", "",
				""
			},
			{
				...
				"Schalte die Zündung aus & stelle den Gaszug ein...", "Nur deaktivieren, wenn die 2.Drosselklappen\roder die 2.Drosseleinrichtung (Schrittmotor & TPS) ausgebaut wurden    ", "TPS-Spannung zu hoch", "&Anpassung Zurücksetzen", "Anpassung Zurücksetzen ?", "Anpassung Zurücksetzen fertig.\r", "Bitte warten... Abgasklappe wird positioniert", "Die Auspuffklappen Züge können nun eingestellt werden, Doppel-click auf \"Einstellen Abgasklappe (EXBV)\" nach dem Einstellen", "Einstellen Abgasklappe (EXBV)...\r", "Einstellung Abgasklappe (EXBV) fertig",
				...
				"Schalte Zündung AUS\rEntfernen Sie den Programmierungsstecker\rSchalten Zündung AN", "", "Herunterladen fertig... ", "", "ECU Wiederherstellung fertig... ", "", "Kann nicht mit Port ", " kommunizieren", " nicht öffnen", "",
				""
			},
			{
				...
				"Spegni il quadro\rScollega il connettore di programmazione\rAccendi il quadro", "", "Scaricamento eseguito... ", "", "Ripristino ECU eseguito... ", "", "Unable to communicate with Port ", "", "", "",
				""
			},
			{
				...
				"Apague el interruptor de encendido y ajuste el cable de acelerador...", "Desactivar solo si las mariposas de acelerador secundarias\ro el dispositivo de acelerador secundario (motor paso a paso y 2º TPS ) son quitados    ", "Voltaje del TPS demasiado alto", "Resetear &adaptación", "¿Resetear adaptación?", "Reseteo adaptación terminado.\r", "Por favor espere... posicionando la valvula de mariposa", "El cable de la mariposa de escape pueden ser ajustados ahora, doble click en \"Adjuste EXBV\" cuando termine", "Ajuste EXBV...\r", "Ajuste EXBV terminado",
				...
				"Apague el contacto\rDesconecte el conector de programación\rEnciende el contacto", "", "Descarga terminada... ", "", "Recuperación de la ECU terminada... ", "", "Unable to communicate with Port ", "", "", "",
				""
			},
			{
				...
				"Desligue a ignição e ajuste o cabo do acelerador...", "Desabilite somente se as válvulas do 2o acelerador\rou o dispositivo do 2o acelerador (motor de passo & 2o TPS) foram removidos", "Voltagem do TPS muito elevada", "Reset &Adequação", "Reset Adequação?", "Reset Adequação concluído.\r", "Por favor, aguarde... Posicionando a válvula de borboleta", "Os cabos da borboleta de exaustão aora podem ser ajustados. Duplo clique em \"Adjust EXBV\" após concluir", "Ajuste EXBV...\r", "Ajuste EXBV concluído",
				...
				"Desligue a ignição\rRemova o plug de programação\rLigue a ignição", "", "Gravação concluída... ", "", "Recuperação da ECU concluída... ", "", "Unable to communicate with Port ", "", "", "",
				""
			}
		};
	}
