...
public class ISOFT : ISOMain
{
	...
	public static void serialWrite(byte[] data, int len, bool csum)
	{
		...
		catch
		{
			...
			ISOMain.DisplayBox("", ISOMain.LangUI[ISOMain.mLang, 356] + comport.PortName + ISOMain.LangUI[ISOMain.mLang, 356], 2);
		}
	...
	public static void sensorDisplay()
	{
		try
		{
			...
			if (ISOMain.swMode == 2)
			{
				...
				{
					ISOMain.me.pbDash_Update(2, int.Parse(ISORead.dataSensor[2]));
	...
	public static void readTimer()
	{
		...
		//IL_0a6b: Invalid comparison between Unknown and I4
